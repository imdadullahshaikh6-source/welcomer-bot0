...
async def generate_couple_image(client: Client, user1, user2) -> BytesIO:
    ...
    # Try downloading user1 profile photo
    u1_pfp = None
    try:
    ...
    # Try downloading user2 profile photo
    u2_pfp = None
    try:
    ...
    # Fallback dummy avatars if no pfp
    if not u1_pfp:
    ...
    # Circle heart highlight background
